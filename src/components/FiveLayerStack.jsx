...
const LAYERS = [
  ...
  },
  {
    ...
    tag: "L4",
    description: "The authorization message — ISO 8583 — has not changed. Agent identity, TAP credentials, and transaction modality (Human Present vs. Human Not Present) ride in existing private-use Data Elements alongside the standard authorization fields. The goal is backward compatibility with existing merchant and acquirer infrastructure.",
    protocols: [
      { name: "Visa TAP credential", coverage: "TAP JWT in private authorization metadata; agent-context signal in authorization metadata (illustrative indicator)" },
    ...
    field: "agent-context metadata · private data element · lifecycle link",
