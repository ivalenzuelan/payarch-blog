const fields = [
  ...
  },
  {
    ...
    name: 'Agent initiation context',
    source: 'Payment rail',
    value: 'network-specific',
    purpose: 'Illustrates that downstream systems may need a way to select agent-specific risk rules.',
  },
  {
    field: 'Private data',
    name: 'Additional authorization evidence',
    source: 'TAP + data enrichment',
    value: 'agent identity + enriched context',
    purpose: 'May carry agent and transaction evidence where the network implementation permits it.',
  },
  {
    field: 'Private reference',
    name: 'Instruction binding',
    source: 'TAP + VIC API',
