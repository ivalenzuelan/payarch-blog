const primitives = [
  ...
  },
  {
    ...
    evidence: ["F002 token", "F022=81", "F048 agent_id"],
  ...
  },
  {
    ...
    layer: "Card network",
    evidence: ["instruction_ref", "F126 hash", "merchant + amount match"],
...
const systems = [
  {
    ...
    note: "Most explicit ISO 8583 mapping: F022, F048, and F126 carry the new evidence downstream.",
    color: "var(--diagram-1)",
  },
  {
    name: "Mastercard",
