...
const AI_NATIVE = [
  ...
  },
  {
    ...
    border: "color-mix(in srgb, var(--success) 28%, var(--ink-200))",
    role: "infrastructure",
    detail: "New: TAP (Visa) or Agent Pay (Mastercard) as identity layer pre-payment. Token service can issue scoped credentials, and authorization metadata can carry agent and consumer-policy evidence where the network implementation supports it.",
    changed: true,
  ...
  },
  {
    id: "acquirer",
    label: "Acquirer",
    sub: "Authorization metadata",
    color: "var(--diagram-3)",
    bg: "color-mix(in srgb, var(--warning) 6%, var(--paper-pure))",
    border: "color-mix(in srgb, var(--warning) 32%, var(--ink-200))",
    role: "infrastructure",
    detail: "Tokenized credential, agent identity evidence, and delegated payment context can be passed into the authorization path. Exact data elements, private fields, and values are not public specifications.",
    changed: true,
    change: "token + agent context + delegated policy",
  },
  {
    id: "merchant",
    label: "Merchant",
    ...
    border: "var(--ink-200)",
    role: "actor",
    detail: "Visa: TAP verifies signed agent requests. Mastercard: Agent Pay supports recognized agent flows. Merchant integration details differ, and exact verdict formats are implementation-specific.",
    changed: true,
