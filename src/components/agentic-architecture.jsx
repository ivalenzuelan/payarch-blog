...
const CONNECTIONS = [
  ...
  // Agent calls VIC API to get VCN — this is the real pre-checkout server call
  ...
  // TAP is a signing protocol in the HTTP headers — no Visa server round-trip
  { from: "agent",    to: "merchant", label: "HTTP + TAP signature",     type: "identity" },
  // Merchant/CDN verifies signature against Visa Key Store (cached public key)
