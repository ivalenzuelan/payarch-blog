...
CAPTCHA assumes a human solves the puzzle. AVS assumes a human typed their address. Device fingerprinting assumes a human browser. 3DS assumes a human can respond to a challenge in real time. AI agents fail every assumption simultaneously — which is why patching individual layers doesn't work. The whole stack has to be rebuilt.
</Callout>
