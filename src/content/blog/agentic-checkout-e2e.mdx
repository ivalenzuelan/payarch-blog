...
Public Visa and Cloudflare documents do **not** publish exact ISO 8583 data element numbers or values for agentic transactions. So any diagram that shows `F022`, `F048`, or `F126` should be read as packet anatomy: where this kind of context can travel in a card-network authorization, not a public Visa field specification.
