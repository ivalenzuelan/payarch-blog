...
<div className="grid grid-cols-3 gap-3 my-8 not-prose">
  <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 text-center">
    <div className="text-2xl font-semibold text-slate-800 font-mono tabular-nums">1,100ms</div>
    <div className="text-xs text-slate-500 mt-2 uppercase tracking-wide">End-to-end latency</div>
  </div>
  <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 text-center">
    <div className="text-2xl font-semibold text-slate-800 font-mono tabular-nums">4,700%</div>
    <div className="text-xs text-slate-500 mt-2 uppercase tracking-wide">AI retail traffic growth</div>
  </div>
  <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 text-center">
    <div className="text-2xl font-semibold text-slate-800 font-mono tabular-nums">$40B</div>
    <div className="text-xs text-slate-500 mt-2 uppercase tracking-wide">Fraud blocked in 2023</div>
  </div>
</div>
...
<div className="grid grid-cols-2 gap-4 my-6 not-prose text-sm">
...
<div className="not-prose my-6 space-y-3">
  <div className="border border-slate-200 rounded-xl p-4 flex gap-4 items-start bg-white">
...
<div className="not-prose my-6 space-y-3">
  <div className="flex gap-4 items-start border border-slate-200 bg-white p-4 rounded-xl">
...
<div className="not-prose my-6 border border-slate-200 rounded-xl overflow-hidden divide-y divide-slate-100 bg-white">
  <div className="p-4 flex items-center gap-4">
    ...
    <div>
      ...
      <div className="text-xs text-slate-500 mt-0.5">Ed25519 key registration, nonce store design, why replay protection is harder than it looks.</div>
    </div>
  </div>
  <div className="p-4 flex items-center gap-4">
  ...
  <div className="p-4 flex items-center gap-4">
    ...
    <div>
      <div className="font-semibold text-slate-800 text-sm">x402 in depth</div>
      <div className="text-xs text-slate-500 mt-0.5">The payment flow, facilitator architecture, V2 spec changes, when to use it over TAP.</div>
    </div>
  </div>
</div>
